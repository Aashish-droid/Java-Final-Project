...
public interface PharmaService {
	...
	public MedInfo editMedicine(MedInfo medicine) throws MedInfoDoesNotExistException ;		// Edit/update an existing medicine in the repository and return the updated medicine.
	...
	public CustomerInfo editCustomer(CustomerInfo customer) throws CustomerInfoDoesNotExistException;	// Edit/update an existing customer in the repository and return the updated customer.
	...
	public SalesInfo findSale(long Id)   throws SaleIdNotFoundException ;     // Find and return a sale from the repository based on the provided sale ID.
